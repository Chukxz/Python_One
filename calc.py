...
button_clear = Button(root, text="Clear", padx=79, pady=20, command=button_remove)
...
button_multiply = Button(root, text="x", padx=40,pady=20,command=button_multiplies)
button_divide = Button(root, text="/", padx=41,pady=20,command=button_divides)
